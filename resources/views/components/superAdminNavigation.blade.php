@extends('base')
    ...
    <div class="w-full bg-[#4d0F0F] h-[90px] flex items-center justify-between px-6">
        ...
        <div class="flex items-center space-x-6 text-white font-[Manrope]">
          <a href="{{ route('super-admin.reports') }}" class="flex items-center rounded border border-white space-x-2 p-1 hover:bg-gray-100 hover:text-red-500 transition duration-200 cursor-pointer group">
