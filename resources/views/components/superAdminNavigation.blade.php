    ...
    <div class="w-full bg-[#4d0F0F] h-[90px] flex items-center justify-between px-6">
        ...
        <div class="flex items-center space-x-6 text-white font-[Manrope]">
            ...
            <div class="relative" id="adminDropdownContainer">
                <button id="adminDropdownBtn" type="button" class="flex items-center space-x-2 cursor-pointer">
                ...
                <!-- Dropdown Menu -->
                <div id="adminDropdownMenu" class="absolute right-0 mt-2 w-35 bg-white rounded-[16px] shadow-lg py-1 hidden z-50 border-2 border-[#4D0F0F] cursor-pointer">
                    <!-- Settings Option -->
                    <a href="{{ route('super-admin.settings') }}" class="flex items-center justify-center px-4 py-2 text-sm text-[#332B2B]">
                    ...
                    <form method="POST" action="{{ route('superadmin.logout') }}" class="block">
                        @csrf
                        <button type="submit" class="w-full flex items-center justify-center px-4 py-2 text-sm text-[#332B2B] cursor-pointer">
