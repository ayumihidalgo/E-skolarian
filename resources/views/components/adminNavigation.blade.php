...
<div class="flex relative">
    <!-- Sidebar -->
    <div id="sidebar" class="w-1/4 h-screen bg-[#7A1212] text-white p-6 flex flex-col">
        <div class="flex items-center space-x-2">
            <a href="#">
                <img src="{{ asset('images/officialLogo.svg') }}" alt="Logo" class="h-20 w-20 shrink-0">
            </a>
            <div class="sidebar-text transition-none !duration-0">
                <a href="#">
        ...
        <nav class="space-y-4 text-lg font-[Marcellus_SC] mt-6">
            @foreach ([['Home', 'account.svg', '#'], ['Review', 'archive.svg', route('admin.review')], ['Archive', 'tracker.svg', '#'], ['Calendar', 'calendar.svg', '#'], ['Settings', 'settings.svg', '#']] as [$label, $icon, $route])
                <a href="{{ $route }}"
