...
@section('content')
            ...
            <div id="mainContentArea" class="p-2 sm:p-4 md:p-6 ">
                ...
                <div id="tableView" class="overflow-hidden h-full flex flex-col">
                    ...
                    <div class="p-2 md:p-6 flex flex-col flex-grow">
                        ...
                        <div
                            ...
                            <div class="relative w-full md:w-1/2 md:mr-2">
                                <input id="searchInput" type="text"
                                    class="w-full rounded-full border-1 border-[#9099A5] bg-white h-10 p-4"
                                    placeholder="Search...">
                            ...
                            <div class="flex gap-2 w-full md:w-auto">
                                <div class="relative flex-1 md:w-40">
                                    <select id="organizationFilter"
                                        class="block cursor-pointer appearance-none w-full bg-[#7A1212] hover:bg-[#DAA520] text-white py-2 px-4 pr-8 rounded-full leading-tight focus:outline-none hover:text-white transition-colors duration-200 truncate">
                                        <option
                                            class="bg-white text-black truncate disabled:hover:bg-white disabled:hover:text-black"
                                            value="" disabled selected>Organization</option>
                                        <option class="bg-white text-black truncate" value="">All</option>
                                        @foreach ($organizations as $org)
                                            <option class="bg-white text-black truncate" value="{{ $org }}"
                                                {{ $selectedOrg == $org ? 'selected' : '' }}>
                                                {{ $org }}
                                            </option>
                                        @endforeach
                                    </select>
                                    <div
                                        class="pointer-events-none absolute top-2 right-0 flex items-center px-3 text-white">
                                        <i class="fa-solid fa-sort-down"></i>
                                    </div>
                                </div>
                                <div class="relative flex-1 md:w-40">
                                    <select id="documentTypeFilter"
                                        class="block cursor-pointer appearance-none w-full bg-[#7A1212] hover:bg-[#DAA520] text-white py-2 px-4 pr-6 rounded-full leading-tight hover:text-white transition-colors duration-200 truncate">
                                        <option class="bg-white text-black truncate" value="" disabled selected>
                                            Document Type</option>
                                        <option class="bg-white text-black truncate" value="">All</option>
                                        <option class="bg-white text-black truncate" value="Event Proposal">Event
                                            Proposal
                                        </option>
                                        <option class="bg-white text-black truncate" value="General Plan">General Plan
                                            of
                                            Activities</option>
                                        <option class="bg-white text-black truncate" value="Calendar">Calendar of
                                            Activities
                                        </option>
                                        <option class="bg-white text-black truncate" value="Accomplishment Report">
                                            Accomplishment Report</option>
                                        <option class="bg-white text-black truncate" value="Constitution">Constitution
                                            and
                                            By-Laws</option>
                                        <option class="bg-white text-black truncate" value="Request Letter">Request
                                            Letter
                                        </option>
                                        <option class="bg-white text-black truncate" value="Off-Campus">Off-Campus
                                        </option>
                                        <option class="bg-white text-black truncate" value="Petition">Petition and
                                            Concern
                                        </option>
                                    </select>
                                    <div
                                    ...
                                    <tbody>
                                        @foreach ($documents as $document)
                                            <tr class="border-2 {{ !$document->is_opened ? 'border-[#7A1212] bg-white' : 'border-[#D9D9D9] bg-[#D9ACAC33]' }} cursor-pointer transition-all duration-150 hover:bg-[#DAA52080]"
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        @php
                                                            ...
                                                            $acronym = !empty($tagParts)
                                                                ? strtoupper($tagParts[0])
                                                                : '';
                                                ...
                                                <!-- Organization -->
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="truncate w-48" title="{{ $document->organization }}">
                                                        {{ $document->organization }}</div>
                                                </td>

                                                <!-- Title -->
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="truncate w-64" title="{{ $document->title }}">
                                                        {{ $document->title }}</div>
                                                </td>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap flex items-center">
                                                    ...
                                                    @if (!$document->is_opened)
                                                        <span
                                                            class="ml-2 h-2 w-2 bg-[#7A1212] rounded-full inline-block"></span>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
                        ...
                        @else
                            <div
                                class="bg-white rounded-[24px] shadow-md overflow-hidden p-8 flex flex-col items-center justify-center flex-grow h-auto min-h-[500px]">
                                <img src="{{ asset('images/no_entry.svg') }}" alt="No Data"
                                    class="mb-4 opacity-50 w-40 h-40">
                ...
                <div id="detailsView" class="hidden h-full text-white">
                        ...
                        <div class="flex justify-end space-x-2 mt-3 md:mt-4">
                            <div id="actionButtonsContainer">
                                <button id="rejectButton"
                                    class="bg-[#C42E2E] hover:bg-red-700 text-white font-bold py-1.5 md:py-2 px-6 md:px-10 text-sm md:text-base rounded-full cursor-pointer">Reject</button>
                                <button id="approveButton"
                                    class="bg-[#478642] hover:bg-green-700 text-white font-bold py-1.5 md:py-2 px-5 md:px-8 text-sm md:text-base rounded-full cursor-pointer">Approve</button>
                            </div>
                            <button
                                class="bg-[#7A1212] cursor-pointer text-white font-semibold rounded-full px-4 md:px-8 py-1 md:py-2 text-sm md:text-base hover:bg-[#5d0c0c] focus:outline-none focus:ring-2 focus:ring-[#7A1212] focus:ring-opacity-50"
                                onclick="closeDetailsPanel()">Close</button>
                        </div>
                    </div>
                    ...
                    <div class="p-3 md:p-6 flex flex-col md:flex-row md:space-x-6 space-y-4 md:space-y-0 w-full max-w-7xl">
                        ...
                        <div class="w-full md:w-2/3 bg-[#4D0F0F] rounded-2xl p-4 md:p-6 space-y-4 md:space-y-6">
                            ...
                            <div class="flex justify-between items-start">
                                <div class="font-bold text-sm md:text-base max-w-[70%]">
                                    <p id="documentDate" class="text-xs text-[#FFFFFF91] md:text-sm mb-1 break-words">
                                    </p>
                                    <p id="documentOrg" class="break-words"><span
                                            class="text-[#FFFFFF91] font-normal">From:</span> </p>
                                    <p id="documentTitle" class="break-words"><span
                                            class="text-[#FFFFFF91] font-normal">Title:</span> </p>
                                    <p id="documentType" class="break-words"><span
                                            class="text-[#FFFFFF91] font-normal">Document Type:</span> </p>
                                </div>
                                <div class="text-right">
                                    <p id="documentTag"
                                        class="px-2 md:px-3 text-[#FFFFFF91] py-1 text-xs md:text-sm break-words"></p>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div
                                    class="bg-[#EFEFEF] text-gray-800 rounded-lg p-3 md:p-4 max-h-[200px] overflow-y-auto">
                                    <p class="text-black break-words whitespace-normal text-sm md:text-base"
                                        id="documentSummary">
                            ...
                            <!-- Attachment -->
                            <div>
                                <h2 class="text-base md:text-lg text-[#FFFFFF91] font-bold mb-1 md:mb-2">Attachment
                                </h2>
                            ...
                            <div>
                                ...
                                <div id="processedStatusIndicator"
                                    class="hidden mt-2 p-3 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 rounded">
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-sm font-medium">This document has already been processed and
                                ...
                                <!-- Forward Status -->
                                <div id="forwardedStatusIndicator"
                                    class="hidden mt-2 p-3 bg-blue-100 border-l-4 border-blue-500 text-blue-700 rounded">
                                    <div class="flex">
                                        <div class="flex-shrink-0">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-sm font-medium">You've forwarded this document to <strong
                                                    id="forwardedToUser">another admin</strong> on <span
                                                    id="forwardedDate">loading date...</span></p>
                                            <p class="text-sm mt-1">Message: <span id="forwardedMessage"
                                                    class="italic">Loading message...</span></p>
                                            <p class="text-xs mt-2 font-medium">You can still view the document, but
                                                only
                                                the current receiver can perform actions on it.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div
                            class="w-full md:w-1/3 bg-[#4D0F0F] text-white rounded-2xl p-4 md:p-6 flex flex-col justify-between">
                            <div class="space-y-4 md:space-y-6">
                                <div class="flex items-center space-x-3 md:space-x-4">
                                    <!-- Profile Picture Placeholder -->
                                    <div id="orgProfileContainer"
                                        class="w-12 h-12 bg-gray-300 rounded-full overflow-hidden flex items-center justify-center border border-gray-600">
                                        <span id="orgInitial" class="text-gray-600 text-lg font-bold">O</span>
                                    </div>
                                    <!-- Organization Details -->
                                    <div class="overflow-hidden">
                                        <p id="orgName" class="font-bold text-base md:text-lg truncate">Organization
                                            Name</p>
                                        <p id="orgType" class="text-xs md:text-sm text-gray-300 truncate">Academic
                                            Organization</p>
                                    </div>
                                </div>
                                ...
                                <!-- Comments section -->
                                <div class="space-y-3 md:space-y-4 text-xs md:text-sm overflow-y-auto max-h-[200px] md:max-h-[400px]"
                            ...
                            <div class="mt-4 md:mt-6">
                                <form id="commentForm" class="flex flex-col space-y-2">
                                    ...
                                    <div id="attachmentPreview"
                                        class="hidden flex items-center bg-gray-100 rounded-md p-2 mt-2">
    ...
    <div id="documentViewerModal"
        class="hidden fixed inset-0 bg-black z-50 flex items-center justify-center backdrop-blur-sm"
    ...
    <!-- Approval Modal -->
    <div id="approvalModal" class="hidden fixed inset-0 bg-black z-50 flex items-center justify-center backdrop-blur-sm"
        style="background-color: rgba(0,0,0,0.3);">
        <div class="bg-white w-[30rem] h-[24rem] rounded-2xl shadow-xl p-6">
            ...
            <div class="mt-6 space-y-6">
                <div>
                    ...
                    <button id="sendToAnotherAdminBtn"
                        class="w-full bg-[#7A1212] hover:bg-[#5e0b0b] text-white py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7A1212] focus:ring-opacity-50 cursor-pointer">
        ...
        <div class="bg-white w-[30rem] rounded-2xl shadow-xl p-6">
            <div class="bg-white rounded-t-lg">
                <div class="flex items-center justify-between">
                    ...
                    <button id="closeSendToAdminModalBtn"
                        class="text-gray-500 hover:text-gray-700 focus:outline-none cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mt-6 space-y-4">
                <div>
                    <div class="relative mt-1">
                        <label for="adminSelect" class="absolute -top-2 left-6 bg-white px-1 text-xs text-black">Send
                            to</label>
                        <select id="adminSelect"
                            class="mt-1 block w-full border border-black rounded-md py-2 px-3 shadow-sm focus:ring-[#7A1212] focus:border-[#7A1212] text-sm cursor-pointer">
                            <option value="" disabled selected
                                class="disabled:hover:text-black disabled:hover:bg-white">Select an Admin</option>
                ...
                <div>
                    <div class="relative mt-4">
                        <label for="adminMessage"
                            class="absolute -top-2 left-6 bg-white px-1 text-xs text-black">Message</label>
                        <textarea id="adminMessage" rows="4"
                            class="mt-1 block w-full border border-black rounded-md py-2 px-3 shadow-sm focus:ring-[#7A1212] focus:border-[#7A1212] text-sm"></textarea>
                    </div>
                </div>
                ...
                <div>
                    <button id="sendToAdminSubmitBtn"
                        class="w-full bg-[#7A1212] hover:bg-[#5e0b0b] text-white py-2.5 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7A1212] focus:ring-opacity-50 text-sm font-semibold cursor-pointer">
                        SEND
                    </button>
                </div>
            </div>
    ...
    <div id="finalApprovalMessageModal"
        class="hidden fixed inset-0 bg-black z-50 flex items-center justify-center backdrop-blur-sm"
        style="background-color: rgba(0,0,0,0.3);">
        <div class="bg-white w-[30rem] rounded-xl shadow-xl p-6">
            <div class="flex items-center justify-between mb-2">
                <h3 class="text-lg font-bold text-black">APPROVAL</h3>
                <button id="closeApprovalMessageModalBtn"
                    class="text-gray-500 hover:text-gray-700 focus:outline-none cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
            ...
            <div class="mb-6">
                <textarea id="approvalMessage" rows="5"
                    class="mt-1 block w-full border border-gray-300 rounded-md py-2 px-3 shadow-sm focus:ring-[#7A1212] focus:border-[#7A1212] text-sm"></textarea>
            </div>
            ...
            <div class="text-center">
                <button id="sendApprovalMessageBtn"
                    class="w-full bg-[#7A1212] hover:bg-[#5e0b0b] text-white py-2.5 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7A1212] focus:ring-opacity-50 text-sm font-semibold cursor-pointer">
                    SEND
                </button>
            </div>
    ...
    <div id="finalizeConfirmationModal"
        ...
        <div class="bg-white w-[30rem] rounded-2xl shadow-xl p-6">
            <div class="flex items-center justify-between mb-2">
                ...
                <button id="closeFinalizeModalBtn"
                    class="text-gray-500 hover:text-gray-700 focus:outline-none cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
    ...
    <!-- Reject Modal -->
    <div id="rejectModal" class="hidden fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm"
        style="background-color: rgba(0,0,0,0.3);">
        <div class="bg-white w-[30rem] rounded-2xl shadow-xl p-6">
            <div class="bg-white rounded-t-lg">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-bold text-black">REJECT</h3>
                    <button id="closeRejectModalBtn"
                        class="text-gray-500 hover:text-gray-700 focus:outline-none cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mt-6 space-y-6">
                <div>
                    ...
                    <button id="requestResubmissionBtn"
                        class="w-full bg-[#7A1212] hover:bg-[#5e0b0b] text-white py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7A1212] focus:ring-opacity-50 cursor-pointer">
    ...
    <div id="resubmissionModal" class="hidden fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm"
        style="background-color: rgba(0,0,0,0.3);">
        <div class="bg-white w-[30rem] rounded-2xl shadow-xl p-6">
            <div class="bg-white rounded-t-lg">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-bold text-black">REQUEST RESUBMISSION</h3>
                    <button id="closeResubmissionModalBtn"
                        class="text-gray-500 hover:text-gray-700 focus:outline-none cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mt-6 space-y-4">
                <div>
                    <div class="relative mt-1">
                        <label for="resubmissionMessage"
                            class="absolute -top-2 left-6 bg-white px-1 text-xs text-black">Message</label>
                        <textarea id="resubmissionMessage" rows="4"
                            class="mt-1 block w-full border border-black rounded-md py-2 px-3 shadow-sm focus:ring-[#7A1212] focus:border-[#7A1212] text-sm"></textarea>
                    </div>
                </div>

                <div>
                    <p class="text-xs text-gray-500 text-center">Resend document to the organization with a request for
                        revisions.</p>
                </div>

                <div>
                    <button id="submitResubmissionBtn"
                        class="w-full bg-[#7A1212] hover:bg-[#5e0b0b] text-white py-2.5 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7A1212] focus:ring-opacity-50 text-sm font-semibold uppercase cursor-pointer">
                        Request
                    </button>
                </div>
            </div>
    ...
    <div id="rejectConfirmationModal" class="hidden fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm"
        style="background-color: rgba(0,0,0,0.3);">
        <div class="bg-white w-[30rem] rounded-2xl shadow-xl p-6">
            <div class="bg-white rounded-t-lg">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-bold text-black">REJECT</h3>
                    <button id="closeRejectConfirmationModalBtn"
                        class="text-gray-500 hover:text-gray-700 focus:outline-none cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mt-6 space-y-4">
                ...
                <div>
                    <p class="text-xs text-gray-500 text-center">Marks the document as rejected ends its current
                        processing.</p>
                </div>

                <div>
                    <button id="confirmFinalRejectBtn"
                        class="w-full bg-[#7A1212] hover:bg-[#5e0b0b] text-white py-2.5 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7A1212] focus:ring-opacity-50 text-sm font-semibold uppercase cursor-pointer">
                        Reject
                    </button>
                </div>
    ...
    <div id="finalRejectConfirmationModal"
        ...
        <div class="bg-white w-[30rem] rounded-lg shadow-xl p-6">
            ...
            <div class="flex justify-end space-x-3">
                <button id="cancelFinalRejectBtn"
                    class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 bg-white hover:bg-gray-50 cursor-pointer">
                    Cancel
                </button>
                <button id="finalizeRejectionBtn"
                    class="px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 cursor-pointer">
                    Finalize Rejection
                </button>
            </div>
    ...
    <div id="documentActionToast"
        class="hidden fixed top-5 right-5 w-[90%] max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl bg-white border-l-4 border-gray-400 text-gray-800 shadow-lg rounded-lg flex items-start px-5 py-2 space-x-3 z-50">
        <div>
        ...
        <button type="button" onclick="hideActionToast()"
