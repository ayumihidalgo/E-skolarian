...
<style>
    ...
    td {
        text-align: center;
        font-size: 14px;
        /* Specify the font size to retain consistency */
    }
        ...
        @if ($hasRecords)
            <thead>
                <tr class="text-gray-800 text-sm text-center bg-white">
                    <th class="py-3 px-4 border-b font-extrabold" data-column="0" onclick="sortTable(0)">Organization <i
                            class="sort-icon fas fa-sort"></i></th>
                    <th class="py-3 px-4 border-b font-extrabold" data-column="1" onclick="sortTable(1)">Title <i
                            class="sort-icon fas fa-sort"></i></th>
                    <th class="py-3 px-4 border-b font-extrabold" data-column="2" onclick="sortTable(2)">Date Created <i
                            class="sort-icon fas fa-sort"></i></th>
                    <th class="py-3 px-4 border-b font-extrabold" data-column="3" onclick="sortTable(3)">Type <i
                            class="sort-icon fas fa-sort"></i></th>
                    <th class="py-3 px-4 border-b font-extrabold" data-column="4" onclick="sortTable(4)">Status <i
                            class="sort-icon fas fa-sort"></i></th>
                </tr>
            </thead>
        @endif
            ...
            @empty
                <tr>
                    <td colspan="5" class="py-4 px-4 text-center text-gray-500 font-extrabold empty-state-cell">
                        <img src="{{ asset('images/viewNoFileFound.svg') }}" alt="No File Found" class="mx-auto mb-10"
                            style="height: 80px;">
...
<script>
    ...
    function sortTable(columnIndex) {
        ...
        rows.sort((rowA, rowB) => {
            ...
            return currentSortDirection === 'asc' ? comparison : -
            comparison; // Return comparison based on direction
        });
