                ...
                <div class="flex flex-wrap justify-between items-center">
                    ...
                    <div>
                        <p class="font-semibold text-white/60">
                            {{ \Carbon\Carbon::parse($document['date'])->format('F d, Y g:i A') }}
                        </p>
                    </div>
...
<div id="documentViewerModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center backdrop-blur-sm">
    ...
    function openDocumentViewer(filePath, fileName) {
        ...
        if (['pdf'].includes(fileExtension)) {
            ...
            loadingTask.promise.then(function(pdf) {
                ...
                pdfViewer.innerHTML = '<div class="p-4 bg-red-100 text-red-700 rounded">Failed to load PDF. Please try downloading the file instead.</div>';
            });
            ...
            img.onerror = function() {
                imageViewer.innerHTML = '<div class="p-4 bg-red-100 text-red-700 rounded">Failed to load image.</div>';
            };
