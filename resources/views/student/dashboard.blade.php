            ...
            <div class="flex-grow p-6 space-y-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="bg-white p-4 rounded-xl shadow-md flex justify-between items-center">
                        <div>
                            ...
                            <div id="pending-count" class="text-base xs:text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold">
                                {{ $pendingCount }}</div>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="md:col-span-2 bg-white rounded-xl shadow-md p-4">
                        <h2
                            class="text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px] font-semibold mb-2 flex items-center gap-2">
                                    ...
                                    <div class="mb-4 pb-4 border-b border-gray-300">
                                        ...
                                        @php
                                            ...
                                            $preview =
                                                ...
                                                (strlen($announcement->content) > $maxLength ? '...' : '');
                                        @endphp
                                        <span
                                            class="text-gray-700 whitespace-pre-line break-words">{{ $preview }}</span>
                                        <button class="text-[#7B2323] hover:underline ml-2 text-sm cursor-pointer"
                                    ...
                                    <table class="min-w-full text-sm text-left">
                                        ...
                                        <tbody>
                                            @foreach ($recentDocuments as $doc)
                                                ...
                                                @endif
                                                @php
                                                    $isUnderReview = $doc->reviews->contains(
                                                        fn($review) => strtolower($review->status) === 'under review',
                                                    );
                                                    ...
                                                    $badgeClass =
                                                        $statusColors[$displayStatus] ?? 'bg-gray-200 text-gray-600';
                                                @endphp
                                                <tr class="border-b"
                                                    ...
                                                    <td class="px-3 py-2 font-extrabold text-black">{{ $doc->control_tag }}
                                                    </td>
        ...
        <div class="relative bg-white rounded-xl shadow-lg max-w-xl w-full p-6 z-10">
            <div class="relative mb-2 border-b pb-2">
                <button onclick="closeAnnouncementModal()"
                    class="absolute top-3 right-4 text-2xl text-gray-500 hover:text-gray-700 z-10"
