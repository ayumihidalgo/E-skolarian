                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding: 30px 0 15px; margin: auto; width: 90%;">
                                        <h1 style="font-size: 18px; font-weight: bold; color: #7A1212;">Document Approved</h1>
                                        <p style="font-weight: 600; padding-top: 20px; color:#000000;">
                                            Your document <strong>{{ $document->title }}</strong> has been approved.
                                        </p>
                                        
                                        @if($message)
                                        <div style="background-color: #f8f9fa; padding: 15px; border-left: 4px solid #7A1212; margin: 20px 0;">
                                            <h2 style="font-size: 16px; margin-top: 0; color: #7A1212;">Message from Admin:</h2>
                                            <p style="margin-bottom: 0; color: #333333;">{{ $message }}</p>
                                        </div>
                                        @endif
