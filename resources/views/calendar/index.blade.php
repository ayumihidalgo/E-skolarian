...
<div class="flex min-h-screen">
    ...
    <div class="ml-64 w-full bg-white min-h-screen">
        ...
        <div class="py-8 px-10">
            <!-- Calendar header with title and create button -->
            <div class="mb-8 flex justify-between items-center">
                <h1 class="text-2xl font-normal">Calendar of Activities</h1>
                @if(Auth::user()->role === 'admin')
                    <button onclick="openEventModal()" class="bg-[#7A1212] text-white px-4 py-2 rounded-full hover:bg-[#8A2222] flex items-center">
            ...
            <div class="p-6">
                ...
                <form id="eventForm" class="space-y-4">
                    ...
                    <div class="flex justify-end gap-2">
                        <button type="button" onclick="closeEventModal()" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                            Cancel
                        </button>
                        <button type="button" onclick="saveEvent()" class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#7A1212] hover:bg-[#8A2222]">
                            Save Event
                        </button>
                    </div>
                </form>
...
@push('styles')
    ...
    <style>
        ...
        /* Ensure the calendar is properly contained */
        #calendar-container {
            border-radius: 12px;
            overflow: hidden;
        }
    ...
    <script>
        ...
        window.addEventListener('load', function () {
            ...
            calendarObj = new FullCalendar.Calendar(calendarEl, {
                ...
                initialDate: '2025-04-15', // Set to April 2025 to match the image
                height: 'auto',
                aspectRatio: 1.5, // Ensure the calendar has proper proportions
                headerToolbar: {
                    left: 'prev',
                    center: 'title',
                    right: 'next today'
