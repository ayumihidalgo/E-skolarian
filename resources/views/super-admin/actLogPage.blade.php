        ...
        <div class="flex justify-between items-center mb-8">
            <div class="flex items-center">
                <a href="{{ route('super-admin.dashboard') }}"
                    class="bg-white hover:text-red-800 text-[#7A1212] px-4 py-2 rounded-[16px] font-sm font-[Lexend] inline-flex items-center mr-4">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            <th
                                class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider font-[Lexend]">
                                User</th>
                            <th
                                class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider font-[Lexend]">
                                Action</th>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900 font-[Lexend]">
                                            ...
                                            <div class="text-sm text-gray-500 font-[Lexend]">{{ $activity->user_role_name }}
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <span
                                        class="inline-flex px-3 py-1 text-xs font-semibold bg-gray-100 text-gray-700 rounded-full font-[Lexend]">
                                        {{ strtoupper($activity->action) }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="inline-flex px-2 py-1 text-xs font-medium rounded bg-gray-100 text-gray-700 font-[Lexend]">
                                        {{ $activity->target }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-900 font-[Lexend] max-w-xs truncate">
                                    {{ $activity->description }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 font-[Lexend]">
                                    <div>{{ \Carbon\Carbon::parse($activity->created_at)->format('M d, Y') }}</div>
                                    <div class="text-xs">
                                        {{ \Carbon\Carbon::parse($activity->created_at)->format('H:i:s') }}</div>
                                </td>
                            </tr>
                        @endforeach
                        <tr id="noResultsRow" class="hidden">
                            <td colspan="5" class="text-center py-12 text-gray-500 font-[Lexend]">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <span class="text-sm text-gray-400">Try adjusting your search or filter to find what
