...
class SuperAdminPasswordResetLinkController extends Controller
{
    use LogsActivity;
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'role' => 'required|in:super admin', // Only superadmin allowed
        ]);
    ...
    public function update(Request $request)
    {
        ...
        // Always redirect as super admin
        return redirect()->route('superadmin.password.reset.confirmation');
    }
    }
